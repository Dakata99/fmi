...
\begin{definition}
	\textbf{Частична функция} с домейн \(X\) и кодомейн \(Y\) е всяка
...
\begin{definition}
	\textbf{Тотална функция} с домейн \(X\) и кодомейн \(Y\) е всяка
	релация \mexpr{f \subseteq X \times Y}, такава че за всяко \(x \in X\) съществува точно едно
	\(y \in Y\), такова че \mexpr{(x, y) \in f}, т.е.
	\begin{align*}
		\forall x \in X : ( & [\exists y \in Y : (x, y) \in f] \land                            \\
		                    & [\forall w, z \in Y : (x, w) \in f \land (x, z) \in f \to w = z])
	\end{align*}
\end{definition}
...
\begin{definition}
	...
	\textbf{Обратната функция} на \(f\) се бележи с \(f^{-1}\). Тя е с домейн \(Y\) и кодомейн \(X\) и се
...
\begin{definition}
	Множество \(A\) е \textbf{крайно}, ако:
	\begin{itemize}
...
\begin{definition}
	Множество е \textbf{безкрайно}, ако не е крайно.
\end{definition}

\begin{definition}
	Множество е \textbf{изброимо безкрайно}, ако е равномощно на \(\mathbb{N}\), т.е.
	съществува биекция \mexpr{f: X \to \mathbb{N}}.
\end{definition}

\begin{definition}
	Множество е \textbf{изброимо}, ако е крайно или изброимо безкрайно.
\end{definition}

\begin{definition}
	Множество е \textbf{неизброимо}, ако не е изброимо.
\end{definition}
...
\begin{note}
	...
	\textbf{Рестрикция} на \(f\) върху \(X^{'}\) е \mexpr{f^{'} : X^{'} \to Y}, където
	\mexpr{\forall x \in X^{'}: f^{'}(x) = f(x)}. Бележим рестрикцията на \(f\) с \mexpr{f_{|_{X^{'}}}}.


	\textbf{Характеристична редица} е безкрайна булева редица \mexpr{a_0, a_1, ...}, която определя дадено
	подмножество \(X\) на \(\mathbb{N}\) по следното правило - за всяко \(n \in \mathbb{N}\):
	\begin{enumerate}
		\item ако \(a_n = 1\), то \(n\) се съдържа в \(X\)
		\item ако \(a_n = 0\), то \(n\) не се съдържа в \(X\)
	\end{enumerate}
\end{note}
