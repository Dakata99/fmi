...
void func()
{
    ...
    std::cout << "Diff of b3 and b2 is: "; Bag b6 = b3.diff(b2); b6.print();
    std::cout << std::endl;
    
    b2.print();
    b3.print();
    std::cout << "Symetric diff of b3 and b2 is: "; Bag b7 = b3.symDiff(b2);b7.print();
    std::cout << "Symmetric diff of b2 and b3 is: "; Bag b8 = b2.symDiff(b3);b8.print();
}
