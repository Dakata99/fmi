...
\begin{definition}
    \textbf{Булева ф-я} на \(n\) променливи е всяка ф-я \mexpr{f: J_2^n \to J_2} за някое \(n \ge 1\).
\end{definition}
...
\begin{definition}
    Нека \mexpr{f = (x_1, \dots, x_n)} е булева ф-я.

    Променливата \(x_i\) се нарича \textbf{фиктивна (несъществена)}, ако
    \begin{equation*}
        f(x_1, x_2, \dots, x_{i - 1}, 0, x_{i + 1}, \dots, x_n) = f(x_1, \dots, x_{i - 1}, 1, x_{i + 1}, \dots, x_n)
    \end{equation*}
    за всяка стойност на \((n - 1)\)-вектора \mexpr{x_1x_2 \dots x_{i - 1}x_{i + 1} \dots x_n}.

    Променлива, която не е фиктивна, се нарича \textbf{съществена}.
\end{definition}

\subsection{Формула над множество булеви функции. Булева функция, съответна на дадена формула.} % TODO:
...
\begin{note} % TODO: complete notes
