...
\begin{enumerate}
    ...
    \item Би-импликация \\
    Бележи се с '\mexpr{\iff}'. Би-импликацията на \(p\) и \(q\) е \mexpr{p \iff q} (чете се "\(p\) \totw \(q\)").
    Тя е съставно съждение, което е:
    \begin{itemize}
...
\boxt{Определение} \\
За всеки две съставни съждения \(s\) и \(t\) казваме, че \(s\) и \(t\) са еквивалентни \totw \mexpr{s \iff t} 
