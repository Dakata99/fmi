...
\begin{definition}[неформално]
	М-вото \(F \subseteq F_2\) е \textbf{пълно}, ако всяка булева ф-я \(f \in F_2\) може да бъде
...
\begin{definition}[формално]
	...
	\begin{itemize}
		...
		\item Нека \(f\) и \(g\) са произволни ф-ии от \([F]\) и \(f\) има \(n \ge 1\) променливи. Тогава
		      ...
		      \mexpr{1 \le i \le n}.
	\end{itemize}
	Така \(F\) е \textbf{пълно м-во}, ако \([F] = F_2\).
\end{definition}

\begin{theorem}[на Бул]
	М-вото от трите булеви ф-ии конюнкция, дизюнкция и отрицание \(F = \{\vee, \land, \lnot\}\) е пълно.
\end{theorem}
...
\begin{proof}
	...
	\begin{align*}
		 & F_{n + 1} =                                                                              \\
		 & F_n \cup \{h | \exists f, g_1, ..., g_k \in F_n(h(x_1, ..., x_n) = f(g_1(x1_, ..., x_n),
		..., g_k(x_1, ..., x_n)))\}
	\end{align*}
	Нека \mexpr{G = \cup_{n \in \mathbb{N}} G_n}, където \mexpr{G_0 = G \cup \{I_k^n | 1 \le k \le n\}} и
	\begin{align*}
		 & G_{n + 1} =                                                        \\
		 & G_n \cup \{h | \exists f, g_1, ..., g_k \in G_n(h(x_1, ..., x_n) =
...
\begin{definition}
	\textbf{Литерал} ще наричаме всяко име на променлива (без или с черта отгоре - отрицание). Тези
...
\begin{definition}
	\textbf{Конюктивна клауза} е всяка непразна формула, която се състои от конкатенация на литерали,
...
\begin{definition}
	\textbf{Дизюнктивна клауза} е всяка непразна формула, която се състои от литерали, свързани
...
\begin{example}
	Ако \(x_1, ..., x_6\) са променливи, то дизюнткивни клаузи са
	\begin{align*}
		x_1 \vee x_2            \\
...
\begin{definition}
	\textbf{Пълна конюктивна клауза} е конюктивна клауза, която съдържа точно \(n\) литерала. Тя е
...
\begin{example}
	Ако \(x_1, ..., x_6\) са променливи, то пълни конюнктивни клаузи са
	\begin{align*}
		x_1x_2x_3x_4x_5x_6 \\
...
\begin{definition}
	\textbf{Пълна дизюнктивна клауза} е дизюнктивна клауза, която съдържа точно \(n\) литерала. Тя е
...
\begin{example}
	Ако \(x_1, ..., x_6\) са променливи, то пълни дизюнктивни клаузи са
	\begin{align*}
...
\begin{definition}
	\textbf{Конюктивна нормална форма (КНФ)} е формула, която се състои от една или повече различни
	конюнктивни клаузи, свързани чрез конюнкция. (Ако дизюнктивните клаузи са повече от една, то всяка
	от тях се огражда в скоби).
\end{definition}

\begin{example}
	Ако \(x_1, ..., x_6\) са променливи, то КНФ са
	\begin{align*}
		x_1 \vee x_2 \vee x_6 \\
...
\begin{definition}
	\textbf{Дизюнктивна нормална форма (ДНФ)} е формула, която се състои от една или повече различни
	конюнктивни клаузи, свързани чрез дизюнкция.
\end{definition}

\begin{example}
	Ако \(x_1, ..., x_6\) са променливи, то ДНФ са
	\begin{align*}
...
\begin{definition}
	\textbf{Съвършена конюктивна нормална форма (СъвКНФ)} е конюктивна нормална форма, в която
	участват само пълни дизюнктивни клаузи.
\end{definition}

\begin{example}
	Ако \(x_1, ..., x_6\) са променливи, то СъвКНФ са
	\begin{align*}
...
\begin{definition}
	\textbf{Съвършена дизюнктивна нормална форма (СъвДНФ)} е дизюнктивна нормална форма, в която
	участват само пълни конюнктивни клаузи.
\end{definition}

\begin{example}
	Ако \(x_1, ..., x_6\) са променливи, то СъвДНФ са
	\begin{align*}
...
\begin{definition}
	Ф-я от вида
	\begin{align*}
		f(x_1, ..., x_n) = a_0 \oplus \bigoplus_{1 \le i \le n} a_ix_i \oplus
		\bigoplus_{1 \le i < j \le n} a_{ij}x_ix_j \oplus ... \oplus a_{12...n}x_1x_2...x_n
	\end{align*}
	, където \(a_i \in \{0, 1\}\), наричаме \textbf{полином на Жегалкин}.
\end{definition}
...
\begin{proof}
	...
	\mexpr{f(c_1, ..., c_n) = C \oplus a_{i_1...i_k} = C \oplus b_{i_1...i_k}}, което противоречи на
...
\begin{alg}[за получаване на полинома на Жегалкин]
	...
	Дадените операции се заместват с техните съответсващи от \linebreak
	\mexpr{\{\tilde{0}, \tilde{1}, \land, \oplus\}}.
	\begin{example}
		\begin{align*}
